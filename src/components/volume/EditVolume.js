...
const EditVolume = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (inputText && editor) {
      ...
      baseUrl
        .post(`/api/v1/volume/${id}`, formData)
        .then((response) => {
          ...
          <div className="d-flex">
            ...
            <div className="w-100 p-2">
              ...
              <div className="col-12  p-4 light rounded shadow bg-light">
                <h2 className="text-center mb-3">ویرایش کتاب</h2>
                <form
                ...
                >
                  ...
                  <div className="w-100 h-100 wrap mt-5">
                    <MyEditor
                      ...
                      data={editor}
                      API_URL="/api/v1/volume/upload-image"
                    />
                  </div>
