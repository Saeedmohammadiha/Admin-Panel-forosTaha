  ...
  const handleSubmit = (e) => {
    ...
    if (!inputText) {
      Swal.fire({
        ...
        title: "لطفا رشته تحصیلی را وارد کنید",
        icon: "error",
      }).then(() => {
        setButLoading(false)
      })
      ...
      baseUrl
        .post("/api/v1/fields", { name: inputText })
        .then((response) => {
          ...
          MySwal.fire({
            ...
            setLoading(true);
            setTimeout((window.location.pathname = "/fields"), 2000);
          });
        })
        .catch((err) => {
          ...
          <div className="d-flex">
            ...
            <div className="w-100 p-2">
              ...
              <div className="col-12 h-75 p-4 light rounded shadow bg-light">
                <h2 className="text-center mb-3">افزودن رشته تحصیلی</h2>
                <form
