  ...
  const handleSubmit = (e) => {
    ...
    if (!inputText) {
      MySwal.fire({
        ...
        title: "لطفا نام رشته را وارد کنید",
        icon: "error",
      }).then(() => {
        setButLoading(false)
      })
      ...
      baseUrl
        .put(`/api/v1/fields/${id}`, { name: inputText })
        .then((response) => {
          MySwal.fire({
            confirmButtonText: "باشه",
            title: "ویرایش شد ",
            ...
            setTimeout((window.location.pathname = "/fields"), 1000);
          });
        })
        .catch((err) => {
          ...
          <div className="d-flex">
            ...
            <div className="w-100 p-2">
              ...
              <div className="col-12 h-75 p-4 light rounded shadow bg-light">
                <h2 className="text-center mb-3">ویرایش رشته تحصیلی</h2>
                <form
