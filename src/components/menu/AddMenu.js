...
`;
    ...
    const handleSubmit = (e) => {
        ...
        if (!inputText) {
            ...
            baseUrl
                .post("/api/v1/menu", { name: inputText, parent_id: `${selectedParentOption ? selectedParentOption.value : ''}`, view: `${selectedViewOption ? selectedViewOption.value : ''}` })
                .then((response) => {
                    ...
                    <div className="d-flex">
                        ...
                        <div className="w-100 p-2">
                            ...
                            <div className="col-12 h-75 p-4 light rounded shadow bg-light">
                                <h2 className="text-center mb-3">افزودن  منو</h2>
                                <form
