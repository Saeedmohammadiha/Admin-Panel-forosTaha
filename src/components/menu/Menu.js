...
const Menu = () => {
 ...
 `;
    ...
    const handleSearch = (e) => {
        ...
        baseUrl
            .get(
                `/api/v1/menu?page=${curentPage}&search=${search}`
            )
            .then((response) => {
    ...
    useEffect(() => {
        baseUrl.get(`/api/v1/menu?page=${curentPage}&search=${search}`).then((response) => {
                    ...
                    baseUrl
                        ...
                        .then((response) => {
                            ...
                            MySwal.fire({
                                ...
                                window.location.pathname = "/site/menu";
                            });
                        })
                        .catch((err) => {
                    ...
                    <div className="d-flex">
                        ...
                        <div className="w-100 p-2">
                            ...
                            <div className="col-12 p-4 light rounded shadow bg-light">
                                <h2 className="text-center mb-3">منو اصلی سایت</h2>
