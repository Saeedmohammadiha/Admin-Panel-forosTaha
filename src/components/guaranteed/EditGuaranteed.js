...
const EditGuaranteed = () => {
  ...
  useEffect(() => {
    baseUrl
      .get(`/api/v1/guaranteed/${id}/edit`)
      .then((response) => {
        const data = response.data.data.data;
        setInputText(data.link);
  ...
  const handleSubmit = (e) => {
    ...
    if (inputText && description ) {
      ...
      baseUrl
        .post(`/api/v1/guaranteed/${id}`, formData)
        .then((response) => {
          ...
          <div className="d-flex">
            ...
            <div className="w-100 p-2">
              ...
              <div className="col-12  p-4 light rounded shadow bg-light">
                <h2 className="text-center mb-3">ویرایش صوت</h2>
                <form
                ...
                >
                  ...
                  <div className="article-image-container">
                    <div className="dropzone ">
                      {imageUrl && (
                        <img src={imageUrl} alt="book" className="h-100 w-50" />
                      )}
