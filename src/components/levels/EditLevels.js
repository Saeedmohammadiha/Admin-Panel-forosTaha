...
const EditLevels = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!inputText) {
      ...
      baseUrl
        .put(`/api/v1/levels/${id}`, { name: inputText })
        .then((response) => {
          MySwal.fire({
            confirmButtonText: "باشه",
            title: "ویرایش شد ",
            ...
            setTimeout((window.location.pathname = "/levels"), 1000);
          });
        })
        .catch((err) => {
          ...
          <div className="d-flex">
            ...
            <div className="w-100 p-2">
              ...
              <div className="col-12 h-75 p-4 light rounded shadow bg-light">
                <h2 className="text-center mb-3">ویرایش سطح تحصیلی</h2>
                <form
