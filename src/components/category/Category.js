...
const Category = () => {
 ...
 `;
    ...
    const handleSearch = (e) => {
        ...
        baseUrl
            .get(
                `/api/v1/category?page=${curentPage}&search=${search}`
            )
            .then((response) => {
    ...
    useEffect(() => {
        baseUrl.get(`/api/v1/category?page=${curentPage}&search=${search}`).then((response) => {
                    ...
                    <div className="d-flex">
                        ...
                        <div className="w-100 p-2">
                            ...
                            <div className="col-12 p-4 light rounded shadow bg-light">
                                <h2 className="text-center mb-3"> دسته بندی </h2>
